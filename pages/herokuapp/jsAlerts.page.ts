...
import { DialogOptions, jsDialogHandler } from "../helpers/utils/dialog.helper.ts";

/**
 * Page Object de la pagina https://the-internet.herokuapp.com/javascript_alerts
 *
...
export class JsAlertsPage {
  ...
  constructor(private page: Page) {
    ...
    this.jsConfirmBtn = page.getByRole("button", {
      name: "Click for JS Confirm",
    });
    this.jsPromptBtn = page.getByRole("button", {
